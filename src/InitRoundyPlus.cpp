...
std::shared_ptr<GLObject> InitRoundyPlus(void)
{
  ...
  std::shared_ptr<Mesh> mesh = std::make_shared<Mesh>(GLContext::sphere);
  ...
  chest.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  neck.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  leftShoulder.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  upperLeftArm.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  leftElbow.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  lowerLeftArm.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  rightShoulder.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  upperRightArm.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  rightElbow.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  lowerRightArm.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  abdomen.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  pelvis.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  leftThigh.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  leftKnee.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  leftCalf.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  rightThigh.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  rightKnee.addMesh(std::make_shared<Mesh>(GLContext::sphere));
  ...
  rightCalf.addMesh(std::make_shared<Mesh>(GLContext::sphere));
